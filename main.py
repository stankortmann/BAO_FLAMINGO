...
def run_pipeline(cfg: Config):
    ...
    number = cfg.snapshot.number
    
    
    data = load(soap_hbt_path + str(int(number)) + ".hdf5")
    print("Snapshot", number, "loaded")
...
if __name__ == "__main__":
    ...
    cfg = Config(
        ...
        snapshot=ds.Snapshot(**cfg_dict['snapshot']),
